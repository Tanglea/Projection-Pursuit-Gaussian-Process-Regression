...
#This code is for the experiment for comparing the performance of PPGPR and GP for DETTE & PEPELYSHEV (2010) CURVED FUNCTION
.
# learning_rate = 0.000000001, nu=2.5, train_epoch=200,number of nodes = 7, 14, 21, 28, 35, 42, 49, 56.
library(fields)
library(MASS)
library(SDraw)
