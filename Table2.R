...
#This code is for the experiment for Table 2.

#Current simulation function is Borehole function 
#Current parameters are learning_rate = e-9, train_epoch= 150, number of nodes =35, and Matern kernel with nu=2.5.
library(fields)
library(MASS)
library(SDraw)
